...
- Lorsque l'extension est rencontrée dans fichier --- ~<<myext arg="val" | content>>~ ---
...
[fn:1] Il existe en {{{ocaml}}} une convention de nommage pour les fonctions de conversion. Par exemple, la fonction standard qui convertit un ~int~ en ~string~ s'appelle ~string_of_int~.
C'est en suivant cette convention que l'outil qui transforme du wikicréole en {{{html}}} s'appelle =html_of_wiki=.
